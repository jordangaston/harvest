...
/**
 * Grocery catalog + service unit tests (ported from tests/unit/grocery.test.ts).
 * Offline: an in-memory GroceryRepository exercises the add/merge logic without a DB.
 */
function fakeRepo() {
