import cuisinesJson from '../../seed/cuisines.json' with { type: 'json' };
...
/**
 * The authored cuisine hierarchy — the SINGLE source of truth (`seed/cuisines.json`)
 ...
 * back to its parent for affinity (see `parentCuisine`).
 */
export const CUISINES: CuisineNode[] = cuisinesJson as CuisineNode[];
