 ...
 * recipe-column names. Stored as strings (pg `numeric`). */
...
/** Nutrition on a recipe. Parsed-only: the source published schema.org
 * NutritionInformation. (Computing macros from a food catalog was punted — generic
 * USDA matching couldn't reach usable accuracy; see docs/sprint-cleanup.) */
