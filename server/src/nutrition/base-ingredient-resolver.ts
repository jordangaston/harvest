 ...
 * "grilled chicken"→Chicken and "salmon"→Fish. One resolver, shared by the grounding
 * (`search_catalog`) and the save (`save_member_profile`) paths so they always agree.
 */
