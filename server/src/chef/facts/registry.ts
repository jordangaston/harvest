...
const DEFS: FactDef[] = [
  ...
  { key: 'household.dinners_per_week', description: 'How many dinners to plan per week', factType: 'WEEKLY_DINNERS', scope: 'household', access: 'writable' },
  { key: 'household.lunches_per_week', description: 'How many lunches to plan per week', factType: 'WEEKLY_LUNCHES', scope: 'household', access: 'writable' },
  { key: 'household.breakfasts_per_week', description: 'How many breakfasts to plan per week', factType: 'WEEKLY_BREAKFASTS', scope: 'household', access: 'writable' },
  ...
  { key: 'household.cook_days', description: 'Which nights the household cooks (weekdays); count = how many', factType: 'COOK_DAYS', scope: 'household', access: 'writable' },
