...
const DEFS: FactDef[] = [
  ...
  { key: 'likes', description: 'Foods a member likes', factType: 'TASTE_LIKE', scope: 'member', access: 'writable' },
  { key: 'dislikes', description: 'Foods a member dislikes', factType: 'TASTE_DISLIKE', scope: 'member', access: 'writable' },
