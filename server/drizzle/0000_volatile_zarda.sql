CREATE TYPE "public"."import_job_status" AS ENUM('queued', 'running', 'ready', 'failed');--> statement-breakpoint
...
CREATE UNIQUE INDEX "saved_recipes_user_recipe_uidx" ON "saved_recipes" USING btree ("user_id","recipe_id");--> statement-breakpoint
CREATE INDEX "saved_recipes_user_idx" ON "saved_recipes" USING btree ("user_id","created_at" DESC NULLS LAST);--> statement-breakpoint
